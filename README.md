...
1. Install **JDK 25**.
2. Copy `Aerogel-26.2-13.jar` to a fresh server directory.
3. Start once:

```bash
java -Xms2G -Xmx4G -jar Aerogel-26.2-13.jar nogui
```
...
Artifacts:
- `aerogel-loader/build/libs/Aerogel-26.2-13.jar`
- `aerogel-loader/build/libs/Aerogel-26.2-13-all.jar` (standalone, depending on selected task)
