...
> **Target:** Aerogel `26.2-2`, Minecraft Java Edition `26.2+`, Java `25`  
...
Until the Gradle plugin is published to a public plugin repository, extract `aerogel-gradle-plugin-26.2-2.zip` and point `pluginManagement` at the extracted Maven repository:
