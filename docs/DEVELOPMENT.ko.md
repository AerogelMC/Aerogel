...
> **대상:** Aerogel `26.2-4`, Minecraft Java Edition `26.2+`, Java `25`
...
Gradle 플러그인이 공개 저장소에 배포되기 전까지 `aerogel-gradle-plugin-26.2-4.zip`을 압축 해제하고, 그 안의 Maven 저장소를 `pluginManagement`에 연결합니다.
